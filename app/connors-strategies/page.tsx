  ...
  return (
    <>
      {/* 
        ...
        This tells Google this page is a distinct "Software Application"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "operatingSystem": "Web",
            "description": "A simulation tool for backtesting RSI(2), Connors RSI, and Bollinger Band mean reversion trading strategies.",
            "offers": {
              "@type": "Offer",
              "price": "0",
              "priceCurrency": "USD"
        ...
        <main className="container mx-auto max-w-7xl bg-white p-6 rounded-lg shadow-xl">
          ...
          {results && (
            <div className="space-y-12 animate-fade-in">
              ...
              {/* --- EDUCATIONAL CONTENT SECTION (UPDATED FOR SEO) --- */}
              <section className="mt-12 bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                ...
                <div className="prose prose-gray max-w-none text-gray-700 space-y-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">RSI 2 & Bollinger Band Backtest Rules</h3>
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Reading the Backtest Results</h3>
