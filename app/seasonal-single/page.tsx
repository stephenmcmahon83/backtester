                    ...
                    <article className="mt-16 pt-8 border-t border-gray-200 prose prose-blue max-w-none">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 text-gray-600 text-sm leading-relaxed">
                            <div>
                                ...
                                <p>We scan the entire historical price database for <strong>{ticker}</strong> (spanning {backtestYears} years). For every trading day of the year, we simulate buying and holding for the next 1 to 20 days.</p>
                            </div>
                            <div>
