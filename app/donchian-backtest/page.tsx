...
export default function DonchianBacktestPage() {
  ...
  return (
    <>
      {/* 
        JSON-LD SCHEMA
        Explicitly tells Google this is a "Donchian Channel" software tool 
      */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Donchian Channel Backtester",
            "applicationCategory": "FinanceApplication",
            "operatingSystem": "Web",
            "description": "A trading simulator for the Turtle Trading Donchian Channel breakout strategy.",
            "offers": {
              "@type": "Offer",
              "price": "0",
              "priceCurrency": "USD"
          ...
          {results && (
            <div className="space-y-12">
              ...
              <section className="mt-12 bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Donchian Channel Formula & Calculation</h2>
                ...
                <div className="prose prose-gray max-w-none text-gray-700 space-y-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Turtle Trading Rules: Entry & Exit</h3>
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Trend Following Backtest Results Explained</h3>
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Donchian Channel Risk Management</h3>
