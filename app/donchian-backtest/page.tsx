...
export default function DonchianBacktestPage() {
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Head>
        <title>Donchian Channel Backtester | Breakout Trading Strategy Tester</title>
        <meta 
          name="description" 
          content="Backtest the classic Donchian Channel breakout strategy on any stock. Compare trend-following performance against buy and hold with customizable entry and exit periods." 
        />
        <meta name="keywords" content="Donchian channel, breakout trading, trend following, turtle traders, channel breakout, stock backtester, trading strategy" />
