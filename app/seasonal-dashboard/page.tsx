...
export default function SnapshotPage() {
    ...
    return (
        <>
            {/* 
              JSON-LD SCHEMA
              Tells Google this is a "Scanner Tool" and lists the metrics available.
            */}
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "name": "Daily Stock Seasonality Scanner",
                        "applicationCategory": "FinanceApplication",
                        "operatingSystem": "Web",
                        "description": "A quantitative scanner that ranks stocks by their historical performance on the current trading day.",
                        "offers": {
                            "@type": "Offer",
                            "price": "0",
                            "priceCurrency": "USD"
                        ...
                        "featureList": [
                            "Daily Historical Win Rate",
                            "Forward Return Projections",
                            "Momentum vs Seasonality Analysis"
                        ]
                    })
                }}
            />
            ...
            >
                <header className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Daily Market Seasonality Scanner</h1>
                    <p className="text-gray-500">
                        Historical return probabilities for the upcoming trading day: <strong>#{targetDay}</strong>
                    </p>
                </header>
                ...
                {!loading && !error && snapshotData.length > 0 && (
                    <div className="space-y-16">
                        ...
                        <section className="mt-12 bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                            <h2 className="text-xl font-bold text-gray-900 mb-4">Stock Seasonality Trading Strategy</h2>
                            ...
                            <div className="prose prose-gray max-w-none text-gray-700 space-y-4">
                                ...
                                <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Trailing Momentum vs Seasonal Patterns</h3>
                                ...
                                <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">How to Find High Probability Setups</h3>
                                ...
                                <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Statistical Significance (Years of Data)</h3>
